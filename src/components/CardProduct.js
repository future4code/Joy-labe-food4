...
export const CardProduct = ({ name, image, price, description, idProduct, restaurantId }) => {
  ...
  return (
    <Grid style={{ display: 'flex', width: '328px', height: '125px', border: '1px solid #b8b8b8', borderRadius: '8px' }}>
      <Grid>
